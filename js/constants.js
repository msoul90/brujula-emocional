export const TRANSLATIONS = {
    es: {
        ...
        crisisStep1Body: "Lo que estás sintiendo es real y no tenés que manejarlo solo/a. No hace falta hacer nada perfecto ahora mismo. Solo estar aquí ya es suficiente.",
        crisisStep2Title: "Anclate al presente.",
        crisisStep2Intro: "Recorramos juntos lo que te rodea:",
        crisisStep2Items: "5 cosas que ves|4 cosas que podés tocar|3 cosas que escuchás|2 cosas que olés|1 cosa que saboreás",
        crisisStep3Title: "Una sola cosa.",
        crisisStep3Intro: "Elegí una acción mínima:",
        crisisStep3Actions: "Tomar un vaso de agua|Salir 5 minutos al aire libre|Escribir una palabra que describe cómo te sentís|Llamar a alguien de confianza",
        crisisStep3End: "Listo. Eso es todo lo que necesitás hacer ahora.",
    },
    en: {
        langLabel: "Language",
